...
def build(stats):
    ...
    info = [
        ...
        row("Uptime", "2.5 years in data (Vert)"),
        row("Host", "Brasília, Brazil"),
        row("Kernel", "Data Science, Data Engineering"),
        row("Shell", "Requirements, BI Analysis"),
        row("Career", "Trainee 2024 -> Data Scientist 2025"),
